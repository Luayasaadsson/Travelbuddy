...
const initialState: User = {
  ...
  preferences: {
      ...
      nationalFood:{
          americanFood: false,
          australianFood: false,
          brazilianFood: false,
          britishFood: false,
          cajunCreoleFood: false,
          caribbeanFood: false,
          chineseFood: false,
          ethiopianFood: false,
          frenchFood: false,
          ...
          koreanFood: false,
          mexicanFood: false,
          middleEasternFood: false,
          spanishFood: false,
          thaiFood: false,
          vietnameseFood: false,
          localFood: false,
          mediterraneanFood: false,
      },
      foodDishes: {
          hamburger: false,
          pasta: false,
...
export const userSlice = createSlice({
  ...
  reducers: {
    updateUser: (state, action: PayloadAction<User>) => {
      console.log("action.payload in updateUser in slice: ",action.payload);
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchUser.rejected, (state) => {
      state.sessionInfo.isLoading = false;
      state.sessionInfo.messageToUser = "The user profile cannot be loaded. Please try again later."
