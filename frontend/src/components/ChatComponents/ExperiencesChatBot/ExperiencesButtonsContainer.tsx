...
// import ExperienceChatButtons from "./ExperiencesChatButtons"
...
// export default function ExperiencesButtonsContainer({
//     message,
...
//                               <ExperienceChatButtons
//                                   key={index}
//                                   onFoodChoice={handleChatButtonClick}
//                                   ExperiencesPreference={item.trim()}
