...
const ProfileDetailsSection: React.FC<ProfileDetailsSectionProps> = ({firstName, lastName, userName, city, country, handleFirstNameChange, handleLastNameChange, handleUserNameChange, handleCityChange, handleCountryChange}) => {
    ...
    return (
        <div className="flex w-full flex-col items-start gap-4 text-secondary">
            ...
            <div className="flex w-full max-w-96 flex-col">
                ...
                <Input value={firstName} onChange={(e)=> handleFirstNameChange(e)} placeholder="Enter your first name" />
            </div>
            <div className="flex w-full max-w-96 flex-col">
                <Label className="gap-2 text-secondary">Last name *</Label>
                <Input value={lastName} onChange={(e)=> handleLastNameChange(e)} placeholder="Enter your last name" />
            </div>
            <div className="flex w-full max-w-96 flex-col">
                <Label className="gap-2 text-secondary">Username *</Label>
                <Input value={userName} onChange={(e) => handleUserNameChange(e)} placeholder="Enter your username" />
            </div>
            <div className="flex w-full max-w-96 flex-col">
                <Label className="gap-2 text-secondary">City *</Label>
                <Input value={city} onChange={(e) => handleCityChange(e)} placeholder="Enter the name of your city" />
            </div>
            <div className="flex w-full max-w-96 flex-col">
                <Label className="gap-2 text-secondary">Country *</Label>
                <Input value={country} onChange={(e) => handleCountryChange(e)} placeholder="Enter the name of your country" />
            </div>
        </div>
    )
}
